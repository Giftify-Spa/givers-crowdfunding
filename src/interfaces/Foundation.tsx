 ...
 * @property {number} [lat] - The latitude of the foundation.
 * @property {number} [lng] - The longitude of the foundation.
 ...
 * @property {string[]} [multimedia] - The multimedia content of the foundation.
